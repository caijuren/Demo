...
const incidents: Incident[] = [
  ...
  },
  {
    ...
    handlingMeasures: [
      "【已执行】已补录运维数据导出审批流程，审批编号 OPS-2026-0415-003，该流程已归档至电子审计系统",
      "【已执行】已对许博进行《数据安全管理办法》专项培训，签署《数据安全管理承诺书》，考试得分 96 分",
      "【已执行】临时撤销许博非工作时间（18:00-09:00 及节假日）的 CRM 系统数据导出权限，后续需通过双人审批方可临时开通",
      "【技术管控】CRM 系统新增非工作时间数据导出二次确认弹窗，强制弹窗提示本次操作将被记录并关联至个人审计日志",
      "【技术管控】上线批量数据导出阈值告警：单次导出超过 5,000 条或非工作时间导出超过 1,000 条自动触发 DLP 告警并通知安全运维值班组",
      "【流程优化】修订《运维数据备份操作规范》，明确紧急备份窗口需提前 2 小时在运维工单系统提交申请并经值班负责人审批",
      "【长期跟进】将该事件特征录入员工行为基线模型，后续同类操作将自动与基线偏差比对并实时预警"
    ],
    terminalLogs: [
      {
